        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center p-8 md:p-16">
          <div className="flex flex-col gap-6 max-w-xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              SarthakSetu connects surplus food from restaurants, events, and
              households with NGOs and volunteers who can deliver it to those in
              need.
            </p>
      ...
      <section className="flex flex-col gap-12 items-center">
        <div className="text-center max-w-2xl mx-auto flex flex-col gap-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold">
            How SarthakSetu Works
          </h2>
          <p className="text-muted-foreground text-lg">
            A simple, transparent process to ensure surplus food reaches those
            who need it most.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 w-full">
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <p className="text-muted-foreground">
              Donors quickly list available food, quantity, and pickup location.
            </p>
          </div>
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <p className="text-muted-foreground">
              Verified NGOs and volunteers see nearby listings and claim them
              for pickup.
            </p>
          </div>
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <p className="text-muted-foreground">
              Secure OTP verification at pickup ensures food goes to the right
              hands safely.
            </p>
          </div>
        </div>
