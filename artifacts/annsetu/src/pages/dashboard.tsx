...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground capitalize flex items-center gap-1.5 mt-1">
            ...
            <span
              className={
                profile.role === "admin" ? "text-purple-600 font-medium" : ""
              }
            >
              {profile.role === "ngo"
                ? "NGO / Food Bank"
      ...
      {(profile.role === "ngo" || profile.role === "volunteer") && (
        <NgoDashboard />
      )}
        ...
        {donations && donations.length > 0 ? (
              ...
              >
                ...
                <div className="text-sm text-muted-foreground flex flex-col gap-1">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    {donation.address || "Location provided"}
                  </span>
                </div>
              </div>
            ))}
          ...
          <div className="bg-card border rounded-xl p-8 text-center flex flex-col items-center">
            ...
            <p className="text-muted-foreground mb-4">
              You don't have any available food listed right now.
            </p>
            <Link href="/donate">
  ...
  const quickLinks = [
    {
      ...
      icon: Utensils,
      label: "All Donations",
      desc: "View every listing across the platform",
    ...
    },
    {
      ...
      icon: BarChart3,
      label: "Claims",
      desc: "Monitor all claim activity",
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-2xl p-5 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-purple-700 text-sm">
            You have full visibility across all platform activity.
          </p>
        </div>
      </div>
          ...
          {quickLinks.map((link) => {
            ...
            return (
              <Link key={link.href} href={link.href}>
                <div
                  className={`flex items-center gap-4 border-2 rounded-xl p-4 cursor-pointer hover:shadow-sm transition-shadow ${link.color}`}
                >
