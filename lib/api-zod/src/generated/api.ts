...
export const UpsertMyProfileBody = zod.object({
  "role": zod.enum(['donor', 'ngo', 'volunteer', 'admin']),
  "roles": zod.array(zod.enum(['donor', 'ngo', 'volunteer', 'admin'])).optional(),
  "name": zod.string(),
  "phone": zod.string(),
 ...
 */
export const SwitchActiveRoleBody = zod.object({
  "role": zod.enum(['donor', 'ngo', 'volunteer', 'admin'])
})

export const SwitchActiveRoleResponse = zod.object({
  "id": zod.number(),
  "clerkId": zod.string(),
  "role": zod.enum(['donor', 'ngo', 'volunteer', 'admin']),
  "roles": zod.array(zod.enum(['donor', 'ngo', 'volunteer', 'admin'])),
